README – Projet E-boutique Symfony
Description

Ce projet est une application web développée avec le framework Symfony, simulant une e-boutique en ligne.
Elle permet aux utilisateurs de parcourir des produits, gérer un panier et passer une commande.
...
La gestion complète des utilisateurs (admin, suppression, etc.) n’est pas implémentée (hors scope)
...
Certains calculs du panier peuvent présenter des incohérences
